...
**Note: some users may experience problems with v1.2.10 -- use the development version (1.2.11)**.  
...
# Other 
For an example Shiny app that uses geoRSS, see [here](https://github.com/RobertMyles/shinyGeoRSS).
